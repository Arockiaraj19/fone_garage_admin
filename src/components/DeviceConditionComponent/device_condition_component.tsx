...
import { fetchDeviceCondition,deleteDeviceCondition } from "@/service/device_condition.service";


const DeviceConditionComponent = () => {
...
export default DeviceConditionComponent;
